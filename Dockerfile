...
ARG HADOOP_DEFAULT_FS_ARG="hdfs://hadoop-1.datascience.ch:8020"
ARG HIVE_JDBC_ARG="jdbc:hive2://hadoop-3.datascience.ch:2181,hadoop-2.datascience.ch:2181,hadoop-1.datascience.ch:2181/;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2"
ARG HIVE_SERVER_ARG="hadoop-2.datascience.ch"
ARG HBASE_SERVER_ARG="hadoop-1.datascience.ch"
ARG YARN_NM_HOSTNAME_ARG="hadoop-3.datascience.ch"
ARG YARN_RM_HOSTNAME_ARG="hadoop-1.datascience.ch"
ARG LIVY_SERVER_ARG="http://hadoop-1.datascience.ch:8998/"
